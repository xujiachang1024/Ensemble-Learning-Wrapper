...
def main(debug_mode=True):
    ...
    ensemble_classification_wrapper = EnsembleClassificationWrapper(type="NumPyBased0hlNeuralNetwork", number_models=10, debug_mode=debug_mode)
    ensemble_classification_wrapper.fit(X=X_train, Y=Y_train, batch_size=5, debug_mode=debug_mode)
